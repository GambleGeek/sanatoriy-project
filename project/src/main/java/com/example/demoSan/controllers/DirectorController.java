...
public class DirectorController {
    ...
    public String findEmployee(@RequestParam String name,
        ...
        return "redirect:/director/" + userId.get() + "/allemployees";
    }
    ...
    public String createEmployee(@ModelAttribute("worker") Worker worker,
                                 Model model,
    ...
    public String editEmployee(
                              ...
                              Model model){
        model.addAttribute("workerId", userId.get());
        model.addAttribute("worker", WorkerDAO.showWorker(employeeId));
    ...
    public String updateEmployee(@ModelAttribute("worker") Worker worker,
                                 ...
                                 BindingResult bindingResult){
        if(bindingResult.hasErrors())
            return "/director" + userId.get() + "/directorHome";
        model.addAttribute("workerId", userId.get());
